...
export const CompanyPerks = [
  {
    id: 1,
    icon: require("/public/images/companyperks1.avif"),
  ...
  {
    id: 2,
    icon: require("/public/images/companyperks2.avif"),
    title: "Fast, Free Shipping",
    desc: "All of our products come with free shipping across United States. We won't make you wait long as we ensure the quickest delivery possible to you!",
  },
  {
    id: 3,
    icon: require("/public/images/companyperks3.avif"),
    title: "Professional Assembly",
    desc: "All of our pc's are professionaly assembled by our 10+ years of working experience PC Technicians hand.",
  },
  {
    id: 4,
    icon: require("/public/images/companyperks4.avif"),
